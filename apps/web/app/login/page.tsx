    ...
    <div className="login-page">
      <div className="login-container">
        <div className="login-brand">
          ...
          <p style={{ color: "var(--muted)", lineHeight: 1.6 }}>Intercambio de turnos de clase mundial. Accede con tu cuenta corporativa para publicar, negociar y cerrar acuerdos.</p>
        </div>
        ...
        <div className="login-card">
          ...
          <p style={{ fontSize: "14px", color: "var(--muted)", textAlign: "center", marginBottom: "24px" }}>
            Sin demos ni ejemplos: usa tu email corporativo para continuar
          </p>
